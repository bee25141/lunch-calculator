...
# Generation Time: 2019-10-14 13:35:28 +0000
# ************************************************************
...
VALUES
	...
	(25,3.93,'3.34','2019-07-10 12:28:01','2 for $3.34 hot&spicy mcchicken','180 w adams st, chicago, il 60603','mcdonalds',0.85),
	(26,4.31,'8.36','2019-07-12 16:46:09','chicken bowl','316 n michigan ave, chicago, il 60601','chipotle',1.94),
	(33,NULL,NULL,'2019-09-22 11:28:19',NULL,NULL,NULL,NULL),
	(34,4.5,'9','2019-09-22 11:32:59','test','test','test',2),
	(35,4.5,'9','2019-09-22 11:44:02','test','test','test',2);
...
INSERT INTO `users` (`userID`, `username`, `email`, `password`, `salt`, `session`, `admin`)
VALUES
	(29,'test','test@gmail.com','+9KbLj0tSZI=','c7d0304d3756ac9dbc90d6ad0606ab67e4eeefc1','',0),
	(30,'bee25141','bee25141@gmail.com','YhEWmsnzkAc=','17ebb40726c14a98e042e35682e15bcd5e1ed777','fb7a3620-ebb1-11e9-93fe-0709dd49754a',1);
